...
export const authGuard: CanActivateFn = (route: ActivatedRouteSnapshot, state: RouterStateSnapshot) => {
  ...
  const protectedRoutes: string[] = ['/dashboard', '/workouts', '/update-data', '/reset/:token', '/update-product/:id', '/my-cart', '/create-product', '/nutrition', '/create-article', '/update-article/:id'];
